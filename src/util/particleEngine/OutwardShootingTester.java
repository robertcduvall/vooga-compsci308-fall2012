...
public class OutwardShootingTester extends ParticleEngineTestingUnit{
	...
	private static int densityStartNum = 300;
	...
	protected void setUpParticleEngines() {
		...
		for (int j=0; j<velocities.length-3; j++){
			addParticleEngine(densityStartNum, particleImage, position, vcalculator.scaleVelocity(5,velocities[j]), tolerance, length,0.0,1,false);
		}
