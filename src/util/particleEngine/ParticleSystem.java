...
/**
 * This class wraps around a List of ParticleEngines to be tested
 * by the ParticleEngineTester. The setUpParticleEngine method needs to be
 * implemented by any class that extends ParticleEngineTetingUnit;
 * this method creates the ParticleEngine objects that are stored in the List.
 * 
 * @author Kathleen
 * 
 */
 ...
 */
     ...
     * myParticleEngines.
     */
    protected abstract void setUpParticleEngines ();
     ...
     */
    protected void addParticleEngine (int density, Image particleImage, Point position,
                                      Point velocity, int tolerance, int length, double angleSpan,
                                      int numberOfDirections, Boolean loop) {
        myParticleEngines.add(new ParticleEngine(density, particleImage, position, velocity,
    ...
    protected void addParticleEngine (Image particleImage, Point position, double angleSpan,
                                      int numberOfDirections, Boolean loop) {
        myParticleEngines.add(new ParticleEngine(particleImage, position, angleSpan,
