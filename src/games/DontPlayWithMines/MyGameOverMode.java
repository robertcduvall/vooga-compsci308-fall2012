...
public class MyGameOverMode extends GameMode {
	private static final String myFirstImage = "src/games/DontPlayWithMines/resources/over.gif";
	
    public MyGameOverMode (GameManager gm, String modeName, List<Integer> involvedIDs) {
