...
public class SnakeGame extends JComponent implements DrawableComponent, IArcadeGame {
    ...
    private void initializeGame (Canvas c) {
        ...
        myPlayer =
                new SnakePlayer(myPlayerOneStart, PLAYER_SIZE, new Dimension(myCanvas.getWidth(),
                        myCanvas.getHeight()),
                        PLAYER_IMAGEPATH, new Point(0, 0), PLAYER_HEALTH);

        addSprite(myPlayer);
        Level myCurrentLevel = new MenuLevel(this);
        SnakeActionAdapter inputAdapter;
        inputAdapter = new SnakeActionAdapter(myPlayer);
        ...
        try {
            ...
            myKeyCont.setControl(KeyEvent.VK_W, KeyboardController.PRESSED, inputAdapter, "goUp");
            myKeyCont.setControl(KeyEvent.VK_S, KeyboardController.PRESSED, inputAdapter, "goDown");
            myKeyCont.setControl(KeyEvent.VK_A, KeyboardController.PRESSED, inputAdapter, "goLeft");
            myKeyCont.setControl(KeyEvent.VK_D, KeyboardController.PRESSED, inputAdapter, "goRight");
            myKeyCont.setControl(KeyEvent.VK_SPACE, KeyboardController.RELEASED, inputAdapter, "stop");
            myKeyCont.setControl(KeyEvent.VK_W, KeyboardController.RELEASED, inputAdapter, "stop");
            myKeyCont.setControl(KeyEvent.VK_S, KeyboardController.RELEASED, inputAdapter, "stop");
            myKeyCont.setControl(KeyEvent.VK_A, KeyboardController.RELEASED, inputAdapter, "stop");
            myKeyCont.setControl(KeyEvent.VK_D, KeyboardController.RELEASED, inputAdapter, "stop");
        }
