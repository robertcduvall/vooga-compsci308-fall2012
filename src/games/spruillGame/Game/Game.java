...
import games.spruillGame.levels.*;
 ...
 * @author Jesse Starr
 * 
 *         - I think that one of the above three changed this class and
 *         framework member and simply overwrote previous code rather than
 *         deprecating it... I wouldn't normally be so annoyed, but this took
 *         ALL of sunday night to fix... seriously, from like 9PM to 4AM
 *         (Anyway, this was edited by David Spruill)
 */
...
public class Game extends JComponent implements DrawableComponent, IArcadeGame {
    ...
    private static final int PLAYER_START_HEIGHT = 20;
    ...
    private void initializeGame (Canvas c) {
        ...
        new Point(myCanvas.getWidth() / 2, myCanvas.getHeight()
                - PLAYER_START_HEIGHT);
    ...
    private void createGame () {
        ...
        new Player(myPlayerOneStart, PLAYER_SIZE, new Dimension(
                myCanvas.getWidth(),
        ...
        myCurrentLevel = new Level1(this);
    ...
    public void update () {
        ...
        if (myPlayer.isDead()) {
            ...
            if (loseGame == null)
                myCurrentLevel.setNextLevel(new LoseGame(this));
        ...
        for (Sprite sprite1 : getSprites()) {
            ...
            for (Sprite sprite2 : getSprites()) {
                ...
                if (collisions.size() > 0) {
                    ...
                    if (!collisions.get(1).getType()
                            .equals(collisions.get(0).getType())) {
