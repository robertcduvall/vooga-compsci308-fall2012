...
public class InterceptorAI extends AI {
    ...
    /**
     * Sets the velocity of the its host on an intercept course with the player's last movement.
     */
    @Override
    public void subCalculate (Sprite mySprite, Player myPlayer) {
        ...
        Point myNewVelocity = new Point (playerPosition.x + playerVelocity.x - myPosition.x, playerPosition.y + playerVelocity.y - myPosition.y);
