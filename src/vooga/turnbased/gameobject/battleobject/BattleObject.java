...
public abstract class BattleObject extends GameObject {
     ...
     * the BattleMode.
     * 
     * @param allowableModes A set of Strings that holds all the possible modes
     *        this can exist in
     * @param condition The action that this object can pass to the GameManager,
     *        can be GameEvent.NO_ACTION if no action needed
     * @param stats the battle stats of the object, including its defense,
     *        attack, and health
     ...
     * 
     * @param target The target enemy of this object, should it choose to attack
     *        it.
     ...
     * 
     * @param target The target of this move/attack, can be null, depending on
     *        implementation.
     * @return Returns a message that describes what the Action was that the
     *         BattleObject just took.
     */
     ...
     * depending on
     * which stats for input. Can call <enemy>.takeDamage(damageDone) once the
     * total
     ...
     * 
     * @param isPlayerControlled Pass True if this is a player controlled
     *        BattleObject,
     *        False if it is not
