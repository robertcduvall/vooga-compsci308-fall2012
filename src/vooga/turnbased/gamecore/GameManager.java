...
/**
 * GameManager class that manages interations between the map and battle modes of the game.
 * 
...
public class GameManager {
     ...
     * @return modeObjects A list of all requested GameObjects within all sprites.
     */
    ...
    /**
     * Removes the sprite with the given ID from the list of sprites in the game.
     * 
    ...
    /**
     * Takes events to be handled and deals with each according to the mode and sprites involved.
     */
