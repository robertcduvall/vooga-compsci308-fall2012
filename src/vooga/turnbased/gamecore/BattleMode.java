    ...
    public void configureInputHandling () {
        ...
        try {
            ...
            GamePane.keyboardController.setControl(DEFEND_KEY, KeyboardController.RELEASED, this,
                    "triggerDefendEvent");
            GamePane.keyboardController.setControl(HEAL_KEY, KeyboardController.RELEASED, this,
                    "triggerHealEvent");
            GamePane.keyboardController.setControl(CHARGE_KEY, KeyboardController.RELEASED, this,
                    "triggerChargeEvent");
        }
        catch (Exception e) {
            e.printStackTrace();
