...
public abstract class CollisionChecker {
    ...
    /**
     * This method detects collisions for all the GameObjects within the Level and return
    ...
    /**
     * This method takes two colliding objects and return the corresponding CollsionEvent
    ...
    public CollisionEvent buildCollisionEvent(GameObject a, GameObject b) {
        ...
        try {
            c = (CollisionEvent) Class.forName(className).getConstructor().newInstance(a,b);
        }
