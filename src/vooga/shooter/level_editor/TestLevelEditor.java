...
public class TestLevelEditor {
    ...
    public TestLevelEditor () {
        ...
        String image_path = project_path
                + "/src/vooga/shooter/images/alien.png";
        ...
        Enemy enemy = new Enemy(new Point(0, 0), new Dimension(10, 10),
                new Dimension(100, 100), image_path, new Point(0, 0), 10);
        
        l.addSprite(enemy);

        try {
            System.out.println(XmlUtilities.getXmlAsString(LevelFactory.storeLevel(l)));
        ...
        Level newLevel = LevelFactory.loadLevel(LevelFactory.storeLevel(l));
