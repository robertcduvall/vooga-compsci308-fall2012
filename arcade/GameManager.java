...
public class GameManager {
    ...
    /**
     * Loads a sorted list of the user? scores for that particular game from
    ...
    /**
     * Loads the user? preferences for that particular game from User.xml.
     */
    ...
    /**
     * Returns all reviews for the given game, displaying the current user?
    ...
    /**
     * Gets the user? review for the game, lets the user modify it, and then
    ...
    /**
     * Gets the user? rating for the game, lets the user modify it, and then
